...
//echo "🔍 Iniciando proceso con manejo de múltiples esquemas...\n\n";

// // Configuración para la base LOCAL (siu_wichi)
// $config_wichi = [
//     'host'     => '127.16.1.61',
//     'port'     => '5432',
//     'dbname'   => 'siu_wichi',
...
// // Configuración para el servidor REMOTO (sii)
// $remoteConfig = [
//     'host'     => '172.16.1.58',
//     'port'     => '5432',
//     'dbname'   => 'sii',
...
try {
    ...
    // echo "🔌 Conectando a base local siu_wichi...\n";
    // $connw = new PDO(
    ...
    // $connw->exec("SET search_path TO {$config_wichi['esquema_principal']}, public");
    // echo "✅ Conexión local establecida (Esquema principal: {$config_wichi['esquema_principal']})\n";

    // // 2. Conexión al servidor REMOTO
    // echo "🌐 Conectando a servidor remoto 172.16.1.58...\n";
    // $conn = new PDO(
    //     "pgsql:host={$remoteConfig['host']};port={$remoteConfig['port']};dbname={$remoteConfig['dbname']}",
    //     $remoteConfig['user'],
    //     $remoteConfig['password']
    // );
    // $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    // echo "✅ Conexión remota establecida\n\n";
